...
\begin{equation*}
S(x, P_y) = \sum_{d \mid P_y} \mu(d) \left( \frac{x}{d} - \left\{ \frac{x}{d} \right\} \right)
\end{equation*}
...
\begin{equation*}
S(x, P_y) = x \prod_{p \le y} \left(1 - \frac{1}{p}\right) + R_y(x)
\end{equation*}
where the isolated, cumulative remainder function $R_y(x)$ is defined exactly by:
\begin{equation*}
R_y(x) = -\sum_{d \mid P_y} \mu(d) \left\{ \frac{x}{d} \right\}
\end{equation*}
...
\begin{equation*}
|R_y(x)| \le \sum_{d \mid P_y} \left| \left\{ \frac{x}{d} \right\} - \frac{1}{2} \right| \le 2^{\pi(y) - 1}
\end{equation*}
...
\begin{equation*}
f(x) = \frac{1}{2} - \{x\} = \sum_{k=1}^{\infty} \frac{\sin(2\pi k x)}{\pi k} 
\end{equation*}
...
\begin{equation*}
R_y(x) = \sum_{d \mid P_y} \mu(d) \sum_{k=1}^{\infty} \frac{\sin\left(2\pi k \frac{x}{d}\right)}{\pi k} + O(1) 
\end{equation*}
