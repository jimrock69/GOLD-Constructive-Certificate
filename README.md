...
To verify the Symmetric Sieve Correlation (SSC) logic, navigate to the verifications_instructions folder and follow the steps in the README located there.
